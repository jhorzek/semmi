...
and subsampling methods for model re-specification with modification indices.
...
may be present once or not at all in the subset. semmi will apply specification
search to each of the samples and return the number of times a specific modification
